...
Packages contain useful scripts written by other people
...
We will load in the data from the paper into a variable called fish_df.
This is a subset of the total data and contains all the observations from the month of August.
...
For the first plot, we will filter for just the wildtype (WT) data
This subsets the dataframe from 869,486 to 263,682 
```{r convert times}
